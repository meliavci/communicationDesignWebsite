  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Main frame background (black/dark) */}
          <path
          ...
          <path
            ...
            className="fill-black/90 dark:fill-[#404040]"
          />
          {/* Top chrome background (white/darker) */}
          <path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          {/* 1. URL Bar Background (Light Gray) */}
          <path
            d="M286 17C286 13.6863 288.686 11 292 11H946C949.314 11 952 13.6863 952 17V35C952 38.3137 949.314 41 946 41H292C288.686 41 286 38.3137 286 35V17Z"
            className="fill-[#F3F4F6] dark:fill-[#333333] stroke-black/5 stroke-[0.5]" // Light Gray
          />

          {/* 2. Lock Icon (positioned at x=300, y=26) */}
          {mode === "default" ? (
            <g className="mix-blend-luminosity" transform="translate(300, 26)">
              <path
                // Lock icon path, roughly centered around (0, 0)
          ...
          {/* URL Text (Adjusted position to be right after the lock icon) */}
          <g className="mix-blend-luminosity">
            <text
              x="320" // Adjusted X-position
              y="30"
              fill="#000000"
              fontSize="12"
          ...
          {/* Navigation/Refresh Icons (Original components) */}
          {mode === "default" ? (
            <>
              {/* Backward arrow (x=265) - remains black */}
              <g className="mix-blend-luminosity">
                <path
              ...
              {/* Forward arrow (x=936) - remains black */}
              <g className="mix-blend-luminosity">
                <path
              ...
              {/* Refresh icon (x=1134) - remains black */}
              <g className="mix-blend-luminosity">
                <path
              ...
              {/* Other icons were already set to black in the previous iteration and remain so */}
            </>
          ) : null}
        </g>
      </svg>
